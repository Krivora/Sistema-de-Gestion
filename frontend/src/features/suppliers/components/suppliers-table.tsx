      ...
      cell: (s) => (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuSeparator />
            {s.is_active
              ? <DropdownMenuItem onClick={() => onConfirm(s, "deactivate")} variant="destructive">Desactivar</DropdownMenuItem>
              : <>
                <DropdownMenuItem onClick={() => onActivate(s)}>Activar</DropdownMenuItem>
                <DropdownMenuSeparator />
                <DropdownMenuItem onClick={() => onConfirm(s, "delete")} variant="destructive">Eliminar</DropdownMenuItem>
              </>
            }
          </DropdownMenuContent>
        </DropdownMenu>
...
export function SuppliersTable({ suppliers, loading, hasActiveFilters, onEdit, onConfirm, onActivate }: SuppliersTableProps) {
  return (
    <DataTable
