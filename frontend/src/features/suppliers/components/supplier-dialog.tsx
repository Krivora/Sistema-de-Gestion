...
export function SupplierDialog({ open, onClose, supplier, onSuccess }: Props) {
    ...
    const [errors, setErrors] = useState<Partial<Record<keyof CreateSupplierDto, string>>>({})
    ...
    function set(field: keyof CreateSupplierDto, value: string) {
    ...
    const progress = form.name.trim() ? 100 : 0
