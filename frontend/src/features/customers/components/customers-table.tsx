...
const columns = (onEdit: (c: Customer) => void, onConfirm: (c: Customer) => void): ColumnDef<Customer>[] => [
  {
        ...
        <DropdownMenuContent align="end">
          ...
          {c.is_active && (
            <>
              ...
              <DropdownMenuItem onClick={() => onConfirm(c)} variant="destructive">Desactivar</DropdownMenuItem>
            </>
          )}
        </DropdownMenuContent>
      </DropdownMenu>
...
export function CustomersTable({ customers, loading, hasActiveFilters, onEdit, onConfirm }: CustomersTableProps) {
  return (
    <DataTable
